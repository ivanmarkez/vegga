    ...
    const mobileCards = viewModel.map((item) => `<article class="sector-mobile ${item.order ? "today" : ""}">
      <div class="mobile-head">
        ...
        <div class="mobile-indicators">
          ${item.actual.active ? `<span class="mobile-watering" title="Sector regando ahora" aria-label="Sector regando ahora"><ha-icon icon="mdi:sprinkler-variant"></ha-icon><span>REGANDO</span></span>` : ""}
