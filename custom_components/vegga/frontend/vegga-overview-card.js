  ...
  _render() {
    ...
    const mobileCards = viewModel.map((item) => `<article class="sector-mobile ${item.order ? "today" : ""}">
      <div class="mobile-head">
        ...
        <span class="mobile-status ${item.actual.active ? "active" : ""}"><span class="dot ${item.actual.active ? "active" : ""}"></span>${item.actual.active ? "Regando" : "Parado"}</span>
      </div>
      <div class="mobile-grid">
        <div class="metric"><span>Inicio</span><strong>${this._escape(this._actualMoment(item.actual.started))}</strong></div>
      ...
      ${this._config.show_programs && item.hasPrograms ? `<details class="mobile-programs"><summary><span>Programas relacionados</span><ha-icon icon="mdi:chevron-down"></ha-icon></summary><strong>${this._escape(item.programs)}</strong></details>` : ""}
    </article>`).join("");
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      @media(max-width:899px){.wrap{padding:10px}.summaries{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.summary{padding:9px;min-width:0}.summary>div{min-width:0}.summary-value,.summary-sub{overflow:hidden;text-overflow:ellipsis}.section{margin-top:13px}.section-title{align-items:flex-start;flex-direction:column;gap:2px;margin-bottom:7px}.section-note{text-align:left}.desktop-only{display:none}.mobile-list{display:grid;gap:7px}.sector-mobile{border:1px solid var(--divider-color);border-radius:12px;padding:9px;background:var(--card-background-color);min-width:0}.sector-mobile.today{border-left:3px solid var(--primary-color);padding-left:7px}.mobile-head{display:flex;align-items:center;justify-content:space-between;gap:7px;margin-bottom:7px}.mobile-name{font-size:.94rem;min-width:0;overflow-wrap:anywhere}.mobile-status{display:inline-flex;align-items:center;gap:5px;flex:0 0 auto;color:var(--secondary-text-color);font-size:.67rem;font-weight:700}.mobile-status .dot{width:8px;height:8px}.mobile-status.active{color:var(--success-color,#2e7d32)}.mobile-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1px;border:1px solid var(--divider-color);border-radius:9px;overflow:hidden;background:var(--divider-color)}.metric{display:flex;flex-direction:column;align-items:flex-start;justify-content:center;gap:2px;min-width:0;min-height:45px;padding:6px 5px;background:var(--card-background-color)}.metric span:first-child{font-size:.61rem;line-height:1.1;color:var(--secondary-text-color);white-space:nowrap}.metric strong{max-width:100%;font-size:.74rem;line-height:1.15;font-variant-numeric:tabular-nums;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.metric .delta{gap:3px}.metric .delta:before{width:7px;height:7px}.compact-state{font-size:.68rem!important;color:var(--secondary-text-color)}.compact-state.active{color:var(--success-color,#2e7d32)}.mobile-programs{margin-top:6px;border-radius:8px;background:var(--secondary-background-color);min-width:0}.mobile-programs summary{display:flex;align-items:center;justify-content:space-between;gap:6px;padding:6px 8px;cursor:pointer;list-style:none;color:var(--secondary-text-color);font-size:.68rem;font-weight:650}.mobile-programs summary::-webkit-details-marker{display:none}.mobile-programs summary ha-icon{--mdc-icon-size:15px;transition:transform .15s ease}.mobile-programs[open] summary ha-icon{transform:rotate(180deg)}.mobile-programs strong{display:block;padding:0 8px 7px;font-size:.72rem;line-height:1.3;overflow-wrap:anywhere}.titlebar h2{font-size:1.1rem}}
      @media(max-width:480px){.summary ha-icon{--mdc-icon-size:21px}.summary-title{font-size:.76rem}.summary-value{font-size:.76rem}.summary-sub{font-size:.64rem}.metric{min-height:42px;padding:5px 3px}.metric span:first-child{font-size:.57rem}.metric strong{font-size:.69rem}.mobile-name{font-size:.9rem}.mobile-status{font-size:.63rem}}
